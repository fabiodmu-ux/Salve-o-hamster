...
export const templates = {
    // Rota 'inicio' (Conteúdo original do index.html com caminhos para 'img/')
    inicio: () => `
        <div class="section">    <h2>Nossa História</h2>    <p>Em uma manhã de outono, durante uma caminhada por uma trilha arborizada, nossa fundadora encontrou uma pequena caixa abandonada entre as folhas. Dentro dela, dois hamsters assustados tentavam se esconder do frio. A cena foi comovente — e transformadora.</p>    <p>Foi ali, naquele instante, que nasceu a ideia da ONG <strong>Defenda o Hamster</strong>. Desde então, nossa missão tem sido clara: proteger, cuidar e dar voz aos pequenos roedores que muitas vezes são negligenciados ou descartados como brinquedos descartáveis.</p>    <p>Hoje, somos uma rede de voluntários apaixonados, veterinários parceiros e famílias adotivas que acreditam que cada vida importa — mesmo as menores.</p>    <img src="img/Hamster explorando a floresta.jpg" alt="Hamster explorando a floresta">  </div>
        ...
        <img src="img/na toca.jpg" alt="hamster roborovskir" /> </div>
        ...
        <div class="gallery">      <img src="img/curioso.jpg" alt="curioso na floresta">      <img src="img/hamster-pequeno.jpg" alt="Hamster entre folhas secas">      <img src="img/hamster na floresta.jpg" alt="Hamster explorando o campo">      <img src="img/seu ambiente natural.jpg" alt="Hamster em ambiente natural">    </div>  </div>
    `,
    
    // Rotas fictícias (Mantenha ou complete com seus arquivos)
    sobre: () => `
        <div class="section">
